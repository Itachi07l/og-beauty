...
export default function ImageTrail({ items = [], variant = 1 }) {
  ...
  return (
    <>
    <div className='absolute md:-top-10 top-10 text-center -z-1 md:mt-[10rem]'>
      <h1 className='md:text-8xl text-2xl text-center md:mt-40 font-1 mb-10'>OG perfume </h1>
      <p className='md:text-2xl text-[14px] md:w-[58%] w-[92%] m-auto'>Presenting OG Beauty, your one-stop destination for high-quality beauty and personal care products at prices that won't break the bank. We're dedicated to helping you look and feel your best without emptying your wallet.</p>
    </div>
    <div className="w-full h-[40%] md:h-[80%] relative z-[80] rounded-lg bg-transparent overflow-visible" ref={containerRef}>
      {items.map((url, i) => (
